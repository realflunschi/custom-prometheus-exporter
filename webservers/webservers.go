...
import (
	...
	"github.com/realflunschi/custom-prometheus-exporter/metricscollector"
	...
	if r.Method != http.MethodPost {
		w.Write([]byte(`<html>
					    ...
					    <body>
					       ...
					       <p>For more information, visit <a href=https://github.com/realflunschi/custom-prometheus-exporter>GitHub</a></p>
...
func handleExporterRootEndpoint(name string, endpoint string) func(http.ResponseWriter, *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
		w.Write([]byte(`<html>
							...
							<body>
							   <h1>` + name + `</h1>
							   <p>This exporter was created in YAML using the <a href=https://github.com/realflunschi/custom-prometheus-exporter>Custom Prometheus Exporter</a></p>
